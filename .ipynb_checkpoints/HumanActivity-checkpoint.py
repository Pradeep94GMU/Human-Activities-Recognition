...
# # Directory containing the files you want to include in the zip archive
# directory_path = '/Users/Pradeep/Desktop/MLHAR/my_files'

# # List all files in the directory
# files_to_zip = [os.path.join(directory_path, filename) for filename in os.listdir(directory_path) if os.path.isfile(os.path.join(directory_path, filename))]

# # Name of the zip file
# zip_filename = '27thNovmy_files.zip'

# # Create a zip archive
# with zipfile.ZipFile(zip_filename, 'w') as zipf:
#     for file in files_to_zip:
#         zipf.write(file, os.path.basename(file))  # Use os.path.basename to preserve original file names in the archive
